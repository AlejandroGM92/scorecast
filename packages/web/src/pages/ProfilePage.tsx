  ...
  return (
    <div className="page-container space-y-4">
      ...
      <div className="glass-card p-4 space-y-2">
        <h2 className="font-semibold text-sm text-text-muted uppercase tracking-wide">Comunidad</h2>
        <p className="text-sm text-text-muted">
          Únete al grupo de WhatsApp de SCORECAST para hablar con los demás participantes y estar al tanto de las novedades.
        </p>
        <a
          href="https://chat.whatsapp.com/GXDM5tbLbqYKegztlRpsb9?s=sw&p=i&mlu=2&amv=1"
          target="_blank"
